...
// Tipografía redondeada/bold del original, usando la familia por defecto del sistema
// para no depender de descargas de fuentes.
val ItalkiTypography = Typography(
